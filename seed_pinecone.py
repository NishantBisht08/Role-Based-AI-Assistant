...
# We need the HF_TOKEN and PINECONE_API_KEY
if not os.environ.get("HF_TOKEN") or not os.environ.get("PINECONE_API_KEY"):
    print("ERROR: Please set HF_TOKEN and PINECONE_API_KEY in your .env file!")
    sys.exit(1)
...
print(f"Initializing Pinecone and HuggingFace API...")
